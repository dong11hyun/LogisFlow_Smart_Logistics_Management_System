...
| 4-4😀 | **전략 3: Kafka Producer 구현** | 2h | ✅ `kafka_producer.py` 구현 완료 |
| 4-5😀 | **전략 3: Kafka Consumer 구현** | 3h | ✅ `kafka_consumer.py` 구현 및 에러 핸들링 추가 |
| 4-6😀 | **전략 3: 비동기 전략 API 연결** (`strategy=async`) | 1h | ✅ API 연동 및 테스트 성공 |
